...
import com.example.headsupprepapp.moodle.Celebrity
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class Add_New_celebrtActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_add_new_celebrt2)
        existingCelebrities = intent.extras!!.getStringArrayList("celebrityNames")!!

        etName = findViewById(R.id.edtxtNewName)
        etTaboo1 = findViewById(R.id.dtxttNewTabo1)
        etTaboo2 = findViewById(R.id.edtxtNewTabo2)
        etTaboo3 = findViewById(R.id.edtxtNewTabo3)
        ...
        apiInterface.addCelebrity(
            ...
            override fun onResponse(call: Call<Celebrity>, response: Response<Celebrity>) {
                ...
                if(!existingCelebrities.contains(etName.text.toString().lowercase())){
                    ...
                    Toast.makeText(this@Add_New_celebrtActivity2, "Celebrity Already Exists", Toast.LENGTH_LONG).show()
                }
            }

            override fun onFailure(call: Call<Celebrity>, t: Throwable) {
                progressDialog.dismiss()
                Toast.makeText(this@Add_New_celebrtActivity2, "Unable to get data", Toast.LENGTH_LONG).show()
            }
        })
    }
}